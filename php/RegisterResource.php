...
if (isset($_POST['trade'])) { $Pwdrepeat = $_POST['trade']; }
...
$targetPath = "resource/".$_FILES['file']['name']; // Target path where file is to be stored
...
$num = $data['total'];
$name= $fname.' '.$lname;
$query2 = "insert into service_finder_providers(wp_user_id, admin_moderation, identity, company_name, full_name, email, phone, address, category, parish, trade, travel_parish, travel_CCountry, willing_CCountry, booking_description, picurl) values ('$num','approved', 'approved', '$company','$name', '$email', '$phone', '$address', '$category', '$parish', '$trade', '$Tparish', '$TCCountry', '$WCCountry', '$summary', '$targetPath')";
